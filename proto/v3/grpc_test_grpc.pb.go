...
func (c *grpcTestClient) Test(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/grpc_test.v2.GrpcTest/Test", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedGrpcTestServer) Test(context.Context, *Request) (*Response, error) {
...
func _GrpcTest_Test_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc_test.v2.GrpcTest/Test",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GrpcTestServer).Test(ctx, req.(*Request))
	}
...
var GrpcTest_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpc_test.v2.GrpcTest",
